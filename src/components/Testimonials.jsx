...
const testimonials = [
  ...
  },
  {
    ...
    text: 'Working with Krutika on ML projects was great. She brings fresh perspectives and writes clean, well-documented code.',
    rating: 5,
    emoji: '👩‍💻',
  },
  {
    name: 'Hackathon Team',
    role: 'Team Member',
    text: 'Krutika is a quick learner who picks up new technologies fast. Her enthusiasm for coding makes her an invaluable team member.',
    rating: 5,
    emoji: '🧑‍🤝‍🧑',
  },
]
  ...
  return (
    <section id="testimonials" className="section-padding relative">
      <div className="max-w-6xl mx-auto px-6" ref={ref}>
        ...
        >
          <span className="text-indigo-400 text-sm font-semibold tracking-[0.25em] uppercase">Testimonials</span>
        ...
        >
          <div className="glass-card rounded-3xl p-10 text-center relative overflow-hidden max-w-2xl mx-auto">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="text-4xl mb-4">{testimonials[current].emoji}</div>
